...
using _210921_ETicaret.Models.Account;
using System;
    ...
    public class AccountController : BaseController
    {
        ...
        public ActionResult Profil(int id = 0, string ad = "")
        {
            ...
            if (id == 0)
            {
                ...
                {
                    var guiId = new Guid(ad);
                    currentAddress = context.Addresses.FirstOrDefault(x => x.Id == guiId);
                }
            }
        ...
        public ActionResult ForgotPassword(string email)
        {
            ...
            else
            {
                ...
                mail.SendMail();
                TempData["Info"] = email + " adresinize şifreniz göndrilmiştir.";
